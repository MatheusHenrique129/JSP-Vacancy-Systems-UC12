...
<body>
    ...
    <div class="conteudo centerObject">
        <i class="icons-list uil uil-setting"></i>
        <h1>Lista de Vagas em Aberto</h1>
        <div class="container-infortions">
            <div class="forms">
                <table class="tbl-estrutura centerObject"> 
                    <tr class="colunas">
                        ...
                        <td class="info"><strong>Alterar</strong></td>
                        <td class="info"><strong>Deletar</strong></td>
                    </tr>
                    <% while(result.next()){
                   %>
                    	<tr class="colunas">
	                        ...
	                        <td class="info-white"><a href='alteracaoVaga.jsp?id=<%=result.getLong("idVaga")%>'><i class='icon-delete uil uil-edit'></i></a></td>
		  	    			<td class="info-white"><a href='controller/excluirVaga.jsp?id=<%=result.getLong("idVaga")%>'><i class='icon-delete uil uil-trash-alt'></i></a></td>
                    	</tr>
            ...
            <a href="index.jsp">
                <button type="submit" name="btnCadastrar" >Voltar</button>
            </a>
        </div>
    </div>
</body>
